        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
                  ...
                  >
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a
                          class="nav-link"
                          href="pages/project-overview.html"
                        >
                          Overview
                        </a>
                      </li>
                      ...
                      <li class="nav-item">
                        <a
                          class="nav-link"
                          href="pages/project-budget.html"
                        >
                          Budget
                        </a>
                      </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/apps-file-manager.html">
              <i data-feather="folder-plus" class="nav-icon me-2 icon-xxs">
              </i
              >File Manager
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            >
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a
                    href="pages/components/accordions.html"
                    class="nav-link"
                  >
                    Accordions
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/breadcrumb.html"
                    class="nav-link"
                  >
                    Breadcrumb
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/button-group.html"
                    class="nav-link"
                  >
                    Button group
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/close-button.html"
                    class="nav-link"
                  >
                    Close Button
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/dropdowns.html"
                    class="nav-link"
                  >
                    Dropdowns
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/list-group.html"
                    class="nav-link"
                  >
                    List group
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/navs-tabs.html"
                    class="nav-link"
                  >
                    Navs and tabs
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/offcanvas.html"
                    class="nav-link"
                  >
                    Offcanvas
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/placeholders.html"
                    class="nav-link"
                  >
                    Placeholders
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="pages/components/scrollspy.html"
                    class="nav-link"
                  >
                    Scrollspy
                  </a>
